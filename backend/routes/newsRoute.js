...
router.get('/api/dashboard/news', middleware.auth, newsController.get_dashboard_news)
router.get('/api/dashboard/news/:news_id', middleware.auth, newsController.get_dashboard_single_news)
