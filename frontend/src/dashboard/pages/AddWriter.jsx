  ...
  return (
    <div className='bg-white rounded-md'>
      <div className='flex justify-between p-4'>
        ...
        <Link className='px-3 py-[6px] bg-red-500 rounded-sm text-white hover:bg-red-600' to='/dashboard/writers'>Writers</Link>
      </div>
      <div className='p-4'>
        <form onSubmit={submit}>
          ...
          <div className='mt-4'>
            <button disabled={loader} className='px-3 py-[6px] bg-red-500 rounded-sm text-white hover:bg-red-600' >{loader ? 'Loading...' : 'Add Writer'}</button>
          </div>
        </form>
      </div>
    </div>
