    ...
    return (
        <div className='space-y-6'>
            <div className='bg-white rounded-md p-5'>
                ...
                <p className='text-gray-500 mt-1'>Upload newsroom images for reporters to use in news articles.</p>
            </div>
            ...
            <div className='bg-white rounded-md p-5'>
                ...
                <form onSubmit={uploadImages}>
                    ...
                    <input id='photographer-images' type='file' accept='image/*' multiple onChange={chooseFiles} className='hidden' />
                    ...
                    <button disabled={loader} className='mt-4 px-4 py-2 bg-red-500 text-white rounded hover:bg-red-600'>
