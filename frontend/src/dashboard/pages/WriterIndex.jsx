        ...
        <div className='mt-2'>
            ...
            <div className='bg-white p-4 rounded-md'>
                <div className='flex justify-between items-center mb-4'>
                    <h2 className='text-xl font-semibold text-slate-700'>News for Review</h2>
                ...
                {news.length === 0 && (
                    <div className='text-center py-8'>
                        <p className='text-gray-500'>No news available for review. Wait for submissions from reporters/photographers.</p>
                    </div>
                )}
            </div>
